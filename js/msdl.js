...
function langJsonStrToHTML(jsonStr) {
    ...
    info.innerHTML = "Você precisará escolher o mesmo idioma ao instalar o Windows. Para ver qual idioma você está usando atualmente, vá em <strong>Hora e idioma</strong> nas configurações ou em <strong>Região</strong> no Painel de Controle.";
...
function onDownloadsXhrChange() {
    ...
    if (response.ProductDownloadOptions && response.ProductDownloadOptions.length > 0) {
        ...
        msContent.innerHTML = "<p>Sem downloads disponíveis.</p>";
    }
}
